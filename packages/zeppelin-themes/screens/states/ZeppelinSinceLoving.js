...
const PALLETE_INDEX = 13 // 29 is max
const PALLETE_RANDOM_FLAG = true

const rules = {
  COLOR_BACK      : [ '#E6E2D4', '#f3f0e0' ],
  COLOR_SECONDARY : [ '#b1c2bd', translate('back.8') ],
  COLOR_SELECTION : [ translate('back.opacity.10'), fetchZero ],
  COLOR_0         : [ '#15a1ae', '#fafafa' ],
  COLOR_1         : [ '#00589Ea2', '66' ],
  COLOR_2         : [ '#27797D', translate('dark.1') ],
  COLOR_3         : [ '#7e4f4ee9', 'cc' ],
  COLOR_4         : [ '#f46f19f1', 'aa' ],
  COLOR_5         : [ '#bb2a83ff', 'a1' ],
}
...
test('happy', () => {
  createPaletteTheme({
    ...
    levels       : MAX_LEVELS,
    rate         : RATE,
    publishName  : 'zeppelin.since.loving',
    publishIndex : 3,
  })
})
